        ...
        return (
          <li
            ...
            className={clsx(
              ...
              conditional
                ? // Conditional step — amber accent border + tint so the eye reads
                  // it as "only applies in this sub-case", visually distinct from
                  // the always-runs steps without breaking the rhythm of the list.
